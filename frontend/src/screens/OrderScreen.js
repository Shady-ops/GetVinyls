                ...
                <Col md={8}>
                    <ListGroup variant='flush'>
                        <ListGroup.Item>
                            ...
                            {order.isDelivered ? (
                                <Message variant='success'>Deliveré en {order.DeliveredAt} </Message>
                            ): (
                                <Message variant='danger'>En attende</Message>
                            )}
                        </ListGroup.Item>
                        ...
                        <ListGroup.Item>
                            ...
                            {order.isPaid ? (
                                <Message variant='success'>Payé en {order.paidAt} </Message>
                            ): (
                        ...
                        {!order.isPaid && (
                            <ListGroup.Item>
                                ...
                                {!sdkReady ? (
                                    ...
                                    <Button type='button' className='btn btn-block' onClick={successPaymentHandler}>Appuyer ici pour Payer</Button>
                                )}
                            </ListGroup.Item>
                        )}
